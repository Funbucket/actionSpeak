...
![제한 속도: 트리거, 차량 번호: 변수, 담당 공무원에게 보고: 태그](/posts/guide/utilizing_GTM/1.png)
...
감시카메라에 빗대어 다시 설명하자면, **특정 차량이 제한 속도를 넘었을 때**(트리거), **차량 번호**(변수)를 **담당 공무원에게 보고**(태그)하는 것입니다.
...
## 변수 설정
사용자의 웹사이트 방문 횟수를 알기 위한 변수를 만들겠습니다.
